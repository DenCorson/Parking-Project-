...
int main() {
    ...
    lot2.getSpaces(); // 
    lot2.reserveSpace(1, 6 , 8 ); 
    cout << "There are now " <<lot2.countEmptySpaces() << " empty spaces in this lot." << endl; 
    lot2.display();
    lot2.reserveSpace(1, 7 , 9 ); // reserve space 1 through time ranges 6 - 8 
    ...
    falcultyLot1->reserveFacultySpot(1, 2,5, "232");
    ...
    studentLot1->display();
    studentLot1->reserveStudentSpot(1, 2, 5, "123");
